...
export default function Footer() {
  return <footer
        class="z-20 text-center footer-links bg-black lg:text-left">
        {/* <div
        ...
        <div class="mx-6 py-10 text-center md:text-left font-mono">
          ...
          >
            ...
            <div>
              ...
              <p class="mb-4 flex items-center justify-center md:justify-start">
                ...
                16/2BA,Jawahar Nagar,2nd street, <br/>
                Weavers colony, P.N Road, <br />
                Tirupur.
              </p>
